...
/**
  ...
  * @brief   HAL configuration file for STM32F4xx.
  ******************************************************************************
  * @attention
  *
...
/**
  ...
  *        your application. This value is used by the RCC HAL module to
  *        compute the system frequency (when HSE is used as system clock
